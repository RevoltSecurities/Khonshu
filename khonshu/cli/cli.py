...
class CLI:
    def __init__(self) -> None:
        self.cli = richparser.RichParser(description="Khonshu – A stealthy, concurrent port scanner written in asynchronous python that crafted for speed and accuracy.", auto=False)
    ...
    def build(self):
        ...
        self.cli.add_argument("configuration", "-scan", "--scan-type", type=str, help="type of port scan we need to do (supports: connect,syn,ack,xmas,null,fix,udp,windows and default: connect)",choices=["connect","syn","ack","xmas","null","fin", "udp", "windows"], default="connect")
        ...
        self.cli.add_argument("debug", "-debug", "--debug", action="store_true", help="display the debugging information")
